...
export class Pages
{
    public static SIMULATE_MATCHMAKING_SIMULATIONS: string = "simulateMatchmakingSimulations";
    public static SIMULATE_MATCHMAKING_FORM: string = "simulateMatchmakingForm";
    public static SIMULATE_MATCHMAKING_OUTPUT: string = "simulateMatchmakingOutput";
    public static SIMULATE_MATCHMAKING_RESULTS: string = "simulateMatchmakingResults";
